                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <?php
						foreach ($allProtype as $value){
							?>
                    <li><a href="store.php?typeid=<?php echo $value['type_id']?>"><?php echo $value['type_name'] ?></a>
                    </li>
                    <?php
						}
						?>
                ...
                <ul class="main-nav nav navbar-nav">
                    <?php
						foreach ($allManufactures as $value){
							?>
                    <li><a href="store.php?manuid=<?php echo $value['manu_id']?>"><?php echo $value['manu_name'] ?></a>
                    </li>
                    <?php
						}
						?>

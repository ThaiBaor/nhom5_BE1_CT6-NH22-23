...
<html lang="en">
	...
	<body>
		...
		include "models/manufactures.php";
		...
		if (isset($_GET['typeid'])){
			...
			$productByType = $product1 -> getProductByProtype($_GET['typeid']);			
		}
		?>
		<!-- HEADER -->
		<header>
							...
							<div class="header-search">
								<form>
									<select class="input-select">
										...
										{
											echo "<option value=1>".$value['type_name']."</option>";
										}
										?>
									</select>
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							foreach ($productByType as $value){
								...
								<div class="product">
									<div class="product-img">
										<img style="height:200px" src="./images/<?php echo $value['image']?>" alt="">
